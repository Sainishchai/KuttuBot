...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001834151925').split()]
...
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "📂 <em>File Name</em>: <code>ᴋᴜᴛᴛᴜ ʙᴏᴛ™|{file_name}</code> \n\n🖇 <em>File Size</em>: <code>{file_size}</code> </i>Join</i> [⚡️ᴇʟ ᴅᴏʀᴀᴅᴏ🚬](https://t.me/wudixh)  \n\n🖥 <i>Requests</i> - ||@im_kuttu_bot||")
